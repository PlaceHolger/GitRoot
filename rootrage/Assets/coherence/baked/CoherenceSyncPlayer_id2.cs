...
namespace Coherence.Generated
{
	...
	public class CoherenceSyncPlayer_id2 : CoherenceSyncBaked
	{
		...
		protected void Awake()
		{
			...
			logger = coherenceSync.logger.With<CoherenceSyncPlayer_id2>();
		}
		...
		public override void ReceiveCommand(IEntityCommand command)
		{
			...
			{
				default:
					logger.Warning($"[CoherenceSyncPlayer_id2] Unhandled command: {command.GetType()}.");
					break;
			}
		}
	}
